...
fig = px.bar(df_mean_wind_nve, text_auto='.2',
            title="")
fig.update_traces(textfont_size=12, textangle=0, textposition="inside", cliponaxis=False)
fig.update_layout(xaxis_title="Wind farm", yaxis_title="Mean wind power output", showlegend=False,
...
layout = go.Layout(title_text="", xaxis_title_text="Hourly changes of wind outputs", yaxis_title_text="Probability", barmode="overlay")
...
layout = go.Layout(title_text="", xaxis_title_text="Daily changes of wind outputs", yaxis_title_text="Probability", barmode="overlay")
...
layout = go.Layout(title_text="", xaxis_title_text="Weekly changes of wind outputs", yaxis_title_text="Probability", barmode="overlay")
